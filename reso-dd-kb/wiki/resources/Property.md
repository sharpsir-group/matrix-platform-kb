...
| `LotSizeUnits` | String List, Single | Characteristics | [LotSizeUnits](#lotsizeunits) |  | 88% | A pick list of the unit of measurement for the area (e.g., Square Feet, Square Meters, Acres). | [link](https://ddwiki.reso.org/display/DDW20/LotSizeUnits+Field) |
...
| `PowerProductionType` | String List, Multi | Utilities | [PowerProductionType](#powerproductiontype) | 30% | 5% | A single-value lookup describing the energy source: Photovoltaics \| Wind. | [link](https://ddwiki.reso.org/display/DDW20/PowerProductionType+Field) |
...
| `VirtualTourURLUnbranded` | String | Listing,Marketing |  |  | 92% | The URL of an unbranded virtual tour (no broker identification) for the property. | [link](https://ddwiki.reso.org/display/DDW20/VirtualTourURLUnbranded+Field) |
